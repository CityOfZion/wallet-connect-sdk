...
### NPM
```
npm i @cityofzion/wallet-connect-sdk-react @walletconnect/sign-client@rc @walletconnect/types@rc
```
### YARN
```
yarn add @cityofzion/wallet-connect-sdk-react @walletconnect/sign-client@rc @walletconnect/types@rc
```
